    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2">
          <span role="img" aria-label="comments icon">
            💬
          </span>{' '}
          讀者評論{' '}
          <span className="text-sm font-medium text-slate-400 bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-full">
            {comments?.length || 0} 則
          </span>
        </h2>
      </div>
